...
export class LevFactSheetPDF {
  static async create(
    ...
    <div class="flex-column expanded ">
        ...
        <div class="flex items-center gap-48 "
            style="padding:12px 24px 8px 24px; background-color: #10273D; position: relative;">
            <div class="flex-column" style="flex: 4; gap: 2px;">
                <span
                    style="margin: 0 0 2px 0; color: #0A80BA; font-size: ${data_fs.caracteristicas_fondo.fondo === 'Conexa Peruvian Lending' ? '32px' : '36px'}; font-weight: 100; line-height:32px; display: block;">
                    ${data_fs.caracteristicas_fondo.fondo} - ${data_fs.caracteristicas_fondo.moneda}
                </span>
                <span
                    style="margin: 0 0 0px 0; color: #FFFFFF; font-size: 17px; font-weight: 100; line-height:20px; display: block;">
            ...
            <div class="flex-column"
                style="flex: 1; margin-right:10px; display: flex; align-items: center; justify-content: center; height: 100%;">
        ...
        <div style="padding:8px 24px 0 24px;">
            <div class="flex" style="gap:10px">
                ...
                <div class="flex-column " style="background-color: white; flex: 5;">
                    <p style="color: #0A80BA; font-weight: 500; font-size: 14px; margin-bottom: 4px;">Evolución del Valor
                        Cuota</p>

                    <div
                        style="width: 410px; height: 212px; position: relative; overflow: visible; padding: 0; margin: 2px 0 9px 0;">
                        <img style="width: 410px; height:200px; margin-bottom: 2px" src=" ${htmlChart}" />
                        <div style="position:absolute; bottom:0; right:0">
                            <span style='font-size:8px; color:#10273D;'>Al final de cada trimestre el valor cuota regresa a
                                1.0000</span>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <p
                            style="word-spacing: 0.15em; font-size: 11px; text-align: justify; margin-bottom: 6px; line-height: 1.1;">
                            ${parrafo_1}
                        </p>
                ...
                <div class="flex-column" style="padding:16px; border: 1px solid #0A80BA; flex: 3; border-radius: 12px;">
                    ...
                    <div
                        style="display: flex; justify-content: space-between; font-size: 9px; border-bottom: 1.5px solid #516C7D; padding: 0 8px 4px 8px; margin-bottom: 4px;">
                        <span style=" color: #10273D;">Inicio de Operaciones</span>
                        <span style="color: #0A80BA;">${data_fs.caracteristicas_fondo.ini_op}</span>
                    </div>
                    <div
                        style="display: flex; justify-content: space-between; font-size: 9px; border-bottom: 1.5px solid #516C7D; padding: 0 8px 4px 8px; margin-bottom: 4px;">
                        <span style=" color: #10273D;">Vencimiento</span>
                        <span style="color: #0A80BA;">${data_fs.caracteristicas_fondo.vencimiento}</span>
                    </div>
                    <div
                        ...
                        <span style="color: #0A80BA;">${data_fs.caracteristicas_fondo.iso}</span>
                    </div>
                    <div
                        style="display: flex; justify-content: space-between; font-size: 9px; border-bottom: 1.5px solid #516C7D; padding: 0 8px 4px 8px; margin-bottom: 3px;">
                    ...
                    <div
                        ...
                        <span style="color: #0A80BA;">${data_fs.caracteristicas_fondo.rentabilidad_objetivo} anual</span>
                    </div>
                    <div
                        style="display: flex; justify-content: space-between; font-size: 9px; border-bottom: 1.5px solid #516C7D; padding: 0 8px 4px 8px; margin-bottom: 3px;">
                    ...
                    <div
                        ...
                        <span style="color: #0A80BA;">${data_fs.caracteristicas_fondo.fideicomiso}</span>
                    </div>
                    <div
                        style="display: flex; justify-content: space-between; font-size: 9px; border-bottom: 1.5px solid #516C7D; padding: 0 8px 4px 8px; margin-bottom: 3px;">
                    ...
                    <div
                        style="display: flex; justify-content: space-between; font-size: 9px; padding: 0 8px 4px 8px; margin-bottom: 8px;">
                        <span style=" color: #10273D;">Distribución de beneficios</span>
                        <span style="color: #0A80BA;">Trimestral</span>
                    </div>

                    <p style="font-size: 9px; text-align: justify; margin-bottom: 8px; color: #10273D;"> <span
                            style="color: #0A80BA;">EL ${data_fs.caracteristicas_fondo.fondo.toUpperCase()} - FONDO DE
                            INVERSIÓN</span> tiene como objetivo realizar inversiones principalmente en
                        ...
                        inversiones son aprobadas por un Comité de Inversiones según lo expuesto en su reglamento de
                        participación.
                    </p>

                    <p style="font-size: 9px; text-align: justify;  margin-bottom: 8px; color: #10273D;"> <span
                            style="color: #0A80BA;">CONEXA ASSET MANAGEMENT</span> es una sociedad gestora de
                        fondos de inversión privados, perteneciente a <span style="color: #0A80BA;">CONEXA FINANCIAL
                            GROUP</span>
                    </p>

                    <p style="font-size: 9px; text-align: justify;  margin-bottom: 8px; color: #10273D;">La principal fuente
                        de ingresos del Fondo son los intereses y
                        las comisiones de desembolso que cobra por los
                        financiamientos, los cuales están sujetos al pago del IGV.
                    </p>

                    <p style="font-size: 9px; text-align: justify;  margin-bottom: 8px; color: #10273D;"> <span
                            style="color: #0A80BA;">EL ${data_fs.caracteristicas_fondo.fondo.toUpperCase()} - FONDO DE
                            INVERSIÓN</span> solamente actúa como agente de retención sobre los
                        beneficios de los partícipes.
                    </p>

                    <p style="font-size: 9px; text-align: justify;  margin-bottom: 8px; color:#10273D; font-weight:bold">
                        IMPORTANTE:</p>

                    <p style="font-size: 9px; text-align: justify;  margin-bottom: 8px; color: #10273D; ">Esta información
                        ha sido preparada únicamente con fines
                        informativos para los partícipes del ${data_fs.caracteristicas_fondo.fondo.toUpperCase()} - FONDO DE
                        INVERSIÓN. Se recomienda consultar con su
                        ...
                        pasado no son garantía de resultados futuros.
                    </p>

                    <p style="font-size: 9px; text-align: justify; color: #10273D;">El patrimonio y la contabilidad del
                        fondo son independientes al
            ...
            ">
              ...
              ">
                ...
                <div style="
                  ...
                  width: 100%;
                ">
                    <img class="imgEstadistica" src="${htmlChartActivos}"
  ...
  if (accion === "edit") {
    this.previsualizarPdf(html);
  } else {
    await this.getPdf(html).save();
  }
}
  ...
  private static previsualizarPdf(html) {
    html2pdf().from(html).set(opt_pdf).toPdf().get('pdf').then(function(pdf) {
      var blob = pdf.output('blob');
      var url = URL.createObjectURL(blob);
      
      // Asignar la URL al iframe en tu vista
